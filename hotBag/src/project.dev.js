require = function() {
  ...
  HotUpdate: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "d31aeeaDnxNgZfaTolWCQA6", "HotUpdate");
    "use strict";
    var am, failCount = 0, updating = false, canRetry = false, checkListener, updateListener;
    var ERRCODE = {
    ...
    cc.Class({
      ...
      onLoad: function onLoad() {
        ...
        var storagePath = (jsb.fileUtils ? jsb.fileUtils.getWritablePath() : "/") + "hotBag";
