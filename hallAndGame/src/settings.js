window._CCSettings = {
    ...
    launchScene: "db://assets/Choose/hallScene.fire",
    scenes: [
        {
            url: "db://assets/Choose/hallScene.fire",
            uuid: "2dL3kvpAxJu6GJ7RdqJG5J"
        },
        {
            url: "db://assets/Game1/game1.fire",
            uuid: "1eMaAH7M1DjYQra1unP8EA"
        }
    ],
    packedAssets: {
        "07920d1a2": [
